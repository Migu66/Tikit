...
export function RecommendationsList({ locale, translations }: RecommendationsListProps) {
  ...
  if (error) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-900 font-medium mb-2">{translations.error}</p>
  ...
  if (recommendations.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-2 text-sm text-gray-500">{translations.noData}</p>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        >
          ...
          <span className="hidden sm:inline">
            {regenerating ? translations.regenerating : translations.regenerate}
          </span>
        </button>
      </div>
